...
e_drift <- function(omega, n_ts) {
    .Call('_gmwm2_e_drift', PACKAGE = 'gmwm2', omega, n_ts)
}
...
m2_drift <- function(omega, n_ts) {
    .Call('_gmwm2_m2_drift', PACKAGE = 'gmwm2', omega, n_ts)
}
...
var_drift <- function(omega, n_ts) {
    .Call('_gmwm2_var_drift', PACKAGE = 'gmwm2', omega, n_ts)
}
...
avar_to_cpp <- function(x) {
    .Call('_gmwm2_avar_to_cpp', PACKAGE = 'gmwm2', x)
}
...
avar_mo_cpp <- function(x) {
    .Call('_gmwm2_avar_mo_cpp', PACKAGE = 'gmwm2', x)
}
...
arma_adapter <- function(theta, p, q, tau) {
    .Call('_gmwm2_arma_adapter', PACKAGE = 'gmwm2', theta, p, q, tau)
}
...
jacobian_arma <- function(theta, p, q, tau) {
    .Call('_gmwm2_jacobian_arma', PACKAGE = 'gmwm2', theta, p, q, tau)
}
...
deriv_arma11 <- function(phi, theta, sigma2, tau) {
    .Call('_gmwm2_deriv_arma11', PACKAGE = 'gmwm2', phi, theta, sigma2, tau)
}
...
deriv_2nd_arma11 <- function(phi, theta, sigma2, tau) {
    .Call('_gmwm2_deriv_2nd_arma11', PACKAGE = 'gmwm2', phi, theta, sigma2, tau)
}
...
deriv_ar1 <- function(phi, sigma2, tau) {
    .Call('_gmwm2_deriv_ar1', PACKAGE = 'gmwm2', phi, sigma2, tau)
}
...
deriv_2nd_ar1 <- function(phi, sigma2, tau) {
    .Call('_gmwm2_deriv_2nd_ar1', PACKAGE = 'gmwm2', phi, sigma2, tau)
}
...
deriv_ma1 <- function(theta, sigma2, tau) {
    .Call('_gmwm2_deriv_ma1', PACKAGE = 'gmwm2', theta, sigma2, tau)
}
...
deriv_2nd_ma1 <- function(theta, sigma2, tau) {
    .Call('_gmwm2_deriv_2nd_ma1', PACKAGE = 'gmwm2', theta, sigma2, tau)
}
...
deriv_dr <- function(omega, tau) {
    .Call('_gmwm2_deriv_dr', PACKAGE = 'gmwm2', omega, tau)
}
...
deriv_2nd_dr <- function(tau) {
    .Call('_gmwm2_deriv_2nd_dr', PACKAGE = 'gmwm2', tau)
}
...
deriv_qn <- function(tau) {
    .Call('_gmwm2_deriv_qn', PACKAGE = 'gmwm2', tau)
}
...
deriv_rw <- function(tau) {
    .Call('_gmwm2_deriv_rw', PACKAGE = 'gmwm2', tau)
}
...
deriv_wn <- function(tau) {
    .Call('_gmwm2_deriv_wn', PACKAGE = 'gmwm2', tau)
}
...
derivative_first_matrix <- function(theta, desc, objdesc, tau) {
    .Call('_gmwm2_derivative_first_matrix', PACKAGE = 'gmwm2', theta, desc, objdesc, tau)
}
...
D_matrix <- function(theta, desc, objdesc, tau, omegadiff) {
    .Call('_gmwm2_D_matrix', PACKAGE = 'gmwm2', theta, desc, objdesc, tau, omegadiff)
}
...
Rcpp_ARIMA <- function(data, params) {
    .Call('_gmwm2_Rcpp_ARIMA', PACKAGE = 'gmwm2', data, params)
}
...
sort_mat <- function(x, col) {
    .Call('_gmwm2_sort_mat', PACKAGE = 'gmwm2', x, col)
}
...
rev_col_subset <- function(x, start, end) {
    .Call('_gmwm2_rev_col_subset', PACKAGE = 'gmwm2', x, start, end)
}
...
rev_row_subset <- function(x, start, end) {
    .Call('_gmwm2_rev_row_subset', PACKAGE = 'gmwm2', x, start, end)
}
...
reverse_vec <- function(x) {
    .Call('_gmwm2_reverse_vec', PACKAGE = 'gmwm2', x)
}
...
field_to_matrix <- function(x) {
    .Call('_gmwm2_field_to_matrix', PACKAGE = 'gmwm2', x)
}
...
sum_field_vec <- function(x) {
    .Call('_gmwm2_sum_field_vec', PACKAGE = 'gmwm2', x)
}
...
build_model_set <- function(combs, x) {
    .Call('_gmwm2_build_model_set', PACKAGE = 'gmwm2', combs, x)
}
...
set_seed <- function(seed) {
    invisible(.Call('_gmwm2_set_seed', PACKAGE = 'gmwm2', seed))
}
...
vector_to_set <- function(model_str) {
    .Call('_gmwm2_vector_to_set', PACKAGE = 'gmwm2', model_str)
}
...
find_full_model <- function(x) {
    .Call('_gmwm2_find_full_model', PACKAGE = 'gmwm2', x)
}
...
rank_models_cpp <- function(data, model_str, full_model, alpha, compute_v, model_type, K, H, G, robust, eff, bs_optimism, seed) {
    .Call('_gmwm2_rank_models_cpp', PACKAGE = 'gmwm2', data, model_str, full_model, alpha, compute_v, model_type, K, H, G, robust, eff, bs_optimism, seed)
}
...
auto_imu_cpp <- function(data, combs, full_model, alpha, compute_v, model_type, K, H, G, robust, eff, bs_optimism, seed) {
    .Call('_gmwm2_auto_imu_cpp', PACKAGE = 'gmwm2', data, combs, full_model, alpha, compute_v, model_type, K, H, G, robust, eff, bs_optimism, seed)
}
...
cov_bootstrapper <- function(theta, desc, objdesc, N, robust, eff, H, diagonal_matrix) {
    .Call('_gmwm2_cov_bootstrapper', PACKAGE = 'gmwm2', theta, desc, objdesc, N, robust, eff, H, diagonal_matrix)
}
...
optimism_bootstrapper <- function(theta, desc, objdesc, scales, model_type, N, robust, eff, alpha, H) {
    .Call('_gmwm2_optimism_bootstrapper', PACKAGE = 'gmwm2', theta, desc, objdesc, scales, model_type, N, robust, eff, alpha, H)
}
...
opt_n_gof_bootstrapper <- function(theta, desc, objdesc, scales, model_type, N, robust, eff, alpha, H) {
    .Call('_gmwm2_opt_n_gof_bootstrapper', PACKAGE = 'gmwm2', theta, desc, objdesc, scales, model_type, N, robust, eff, alpha, H)
}
...
gmwm_sd_bootstrapper <- function(theta, desc, objdesc, scales, model_type, N, robust, eff, alpha, H) {
    .Call('_gmwm2_gmwm_sd_bootstrapper', PACKAGE = 'gmwm2', theta, desc, objdesc, scales, model_type, N, robust, eff, alpha, H)
}
...
boot_pval_gof <- function(obj, obj_boot, B = 1000L, alpha = 0.05) {
    .Call('_gmwm2_boot_pval_gof', PACKAGE = 'gmwm2', obj, obj_boot, B, alpha)
}
...
gmwm_param_bootstrapper <- function(theta, desc, objdesc, scales, model_type, N, robust, eff, alpha, H) {
    .Call('_gmwm2_gmwm_param_bootstrapper', PACKAGE = 'gmwm2', theta, desc, objdesc, scales, model_type, N, robust, eff, alpha, H)
}
...
all_bootstrapper <- function(theta, desc, objdesc, scales, model_type, N, robust, eff, alpha, H) {
    .Call('_gmwm2_all_bootstrapper', PACKAGE = 'gmwm2', theta, desc, objdesc, scales, model_type, N, robust, eff, alpha, H)
}
...
Mod_squared_cpp <- function(x) {
    .Call('_gmwm2_Mod_squared_cpp', PACKAGE = 'gmwm2', x)
}
...
#' @keywords internal
Mod_cpp <- function(x) {
    .Call('_gmwm2_Mod_cpp', PACKAGE = 'gmwm2', x)
}
...
compute_cov_cpp <- function(signal_modwt, nb_level, compute_v = "diag", robust = TRUE, eff = 0.6) {
    .Call('_gmwm2_compute_cov_cpp', PACKAGE = 'gmwm2', signal_modwt, nb_level, compute_v, robust, eff)
}
...
fast_cov_cpp <- function(ci_hi, ci_lo) {
    .Call('_gmwm2_fast_cov_cpp', PACKAGE = 'gmwm2', ci_hi, ci_lo)
}
...
dwt_cpp <- function(x, filter_name, nlevels, boundary, brickwall) {
    .Call('_gmwm2_dwt_cpp', PACKAGE = 'gmwm2', x, filter_name, nlevels, boundary, brickwall)
}
...
modwt_cpp <- function(x, filter_name, nlevels, boundary, brickwall) {
    .Call('_gmwm2_modwt_cpp', PACKAGE = 'gmwm2', x, filter_name, nlevels, boundary, brickwall)
}
...
brick_wall <- function(x, wave_filter, method) {
    .Call('_gmwm2_brick_wall', PACKAGE = 'gmwm2', x, wave_filter, method)
}
...
gen_wn <- function(N, sigma2 = 1) {
    .Call('_gmwm2_gen_wn', PACKAGE = 'gmwm2', N, sigma2)
}
...
gen_dr <- function(N, omega = 5) {
    .Call('_gmwm2_gen_dr', PACKAGE = 'gmwm2', N, omega)
}
...
gen_qn <- function(N, q2 = .1) {
    .Call('_gmwm2_gen_qn', PACKAGE = 'gmwm2', N, q2)
}
...
gen_ar1 <- function(N, phi = .3, sigma2 = 1) {
    .Call('_gmwm2_gen_ar1', PACKAGE = 'gmwm2', N, phi, sigma2)
}
...
gen_rw <- function(N, sigma2 = 1) {
    .Call('_gmwm2_gen_rw', PACKAGE = 'gmwm2', N, sigma2)
}
...
gen_ma1 <- function(N, theta = .3, sigma2 = 1) {
    .Call('_gmwm2_gen_ma1', PACKAGE = 'gmwm2', N, theta, sigma2)
}
...
gen_arma11 <- function(N, phi = .1, theta = .3, sigma2 = 1) {
    .Call('_gmwm2_gen_arma11', PACKAGE = 'gmwm2', N, phi, theta, sigma2)
}
...
gen_arma <- function(N, ar, ma, sigma2 = 1.5, n_start = 0L) {
    .Call('_gmwm2_gen_arma', PACKAGE = 'gmwm2', N, ar, ma, sigma2, n_start)
}
...
gen_sarma <- function(N, ar, ma, sar, sma, sigma2 = 1.5, s = 12L, n_start = 0L) {
    .Call('_gmwm2_gen_sarma', PACKAGE = 'gmwm2', N, ar, ma, sar, sma, sigma2, s, n_start)
}
...
gen_arima <- function(N, ar, d, ma, sigma2 = 1.5, n_start = 0L) {
    .Call('_gmwm2_gen_arima', PACKAGE = 'gmwm2', N, ar, d, ma, sigma2, n_start)
}
...
gen_sarima <- function(N, ar, d, ma, sar, sd, sma, sigma2 = 1.5, s = 12L, n_start = 0L) {
    .Call('_gmwm2_gen_sarima', PACKAGE = 'gmwm2', N, ar, d, ma, sar, sd, sma, sigma2, s, n_start)
}
...
gen_generic_sarima <- function(N, theta_values, objdesc, sigma2 = 1.5, n_start = 0L) {
    .Call('_gmwm2_gen_generic_sarima', PACKAGE = 'gmwm2', N, theta_values, objdesc, sigma2, n_start)
}
...
gen_model <- function(N, theta, desc, objdesc) {
    .Call('_gmwm2_gen_model', PACKAGE = 'gmwm2', N, theta, desc, objdesc)
}
...
gen_lts_cpp <- function(N, theta, desc, objdesc) {
    .Call('_gmwm2_gen_lts_cpp', PACKAGE = 'gmwm2', N, theta, desc, objdesc)
}
...
code_zero <- function(theta) {
    .Call('_gmwm2_code_zero', PACKAGE = 'gmwm2', theta)
}
...
gmwm_engine <- function(theta, desc, objdesc, model_type, wv_empir, omega, scales, starting) {
    .Call('_gmwm2_gmwm_engine', PACKAGE = 'gmwm2', theta, desc, objdesc, model_type, wv_empir, omega, scales, starting)
}
...
gmwm_update_cpp <- function(theta, desc, objdesc, model_type, N, expect_diff, ranged, orgV, scales, wv, starting, compute_v, K, H, G, robust, eff) {
    .Call('_gmwm2_gmwm_update_cpp', PACKAGE = 'gmwm2', theta, desc, objdesc, model_type, N, expect_diff, ranged, orgV, scales, wv, starting, compute_v, K, H, G, robust, eff)
}
...
gmwm_master_cpp <- function(data, theta, desc, objdesc, model_type, starting, alpha, compute_v, K, H, G, robust, eff) {
    .Call('_gmwm2_gmwm_master_cpp', PACKAGE = 'gmwm2', data, theta, desc, objdesc, model_type, starting, alpha, compute_v, K, H, G, robust, eff)
}
...
guess_initial <- function(desc, objdesc, model_type, num_param, expect_diff, N, wv, tau, ranged, G) {
    .Call('_gmwm2_guess_initial', PACKAGE = 'gmwm2', desc, objdesc, model_type, num_param, expect_diff, N, wv, tau, ranged, G)
}
...
ar1_draw <- function(draw_id, last_phi, sigma2_total, model_type) {
    .Call('_gmwm2_ar1_draw', PACKAGE = 'gmwm2', draw_id, last_phi, sigma2_total, model_type)
}
...
arma_draws <- function(p, q, sigma2_total) {
    .Call('_gmwm2_arma_draws', PACKAGE = 'gmwm2', p, q, sigma2_total)
}
...
guess_initial_old <- function(desc, objdesc, model_type, num_param, expect_diff, N, wv_empir, tau, B) {
    .Call('_gmwm2_guess_initial_old', PACKAGE = 'gmwm2', desc, objdesc, model_type, num_param, expect_diff, N, wv_empir, tau, B)
}
...
hadam_to_cpp <- function(x) {
    .Call('_gmwm2_hadam_to_cpp', PACKAGE = 'gmwm2', x)
}
...
hadam_mo_cpp <- function(x) {
    .Call('_gmwm2_hadam_mo_cpp', PACKAGE = 'gmwm2', x)
}
...
idf_arma <- function(ar, ma, sigma2, N, robust, eff, H) {
    .Call('_gmwm2_idf_arma', PACKAGE = 'gmwm2', ar, ma, sigma2, N, robust, eff, H)
}
...
idf_arma_total <- function(ar, ma, sigma2, N, robust, eff, H) {
    .Call('_gmwm2_idf_arma_total', PACKAGE = 'gmwm2', ar, ma, sigma2, N, robust, eff, H)
}
...
calculate_psi_matrix <- function(A, v_hat, omega) {
    .Call('_gmwm2_calculate_psi_matrix', PACKAGE = 'gmwm2', A, v_hat, omega)
}
...
format_ci <- function(theta, se, alpha) {
    .Call('_gmwm2_format_ci', PACKAGE = 'gmwm2', theta, se, alpha)
}
...
theta_ci <- function(theta, A, v_hat, omega, alpha) {
    .Call('_gmwm2_theta_ci', PACKAGE = 'gmwm2', theta, A, v_hat, omega, alpha)
}
...
gof_test <- function(theta, desc, objdesc, model_type, tau, v_hat, wv_empir) {
    .Call('_gmwm2_gof_test', PACKAGE = 'gmwm2', theta, desc, objdesc, model_type, tau, v_hat, wv_empir)
}
...
bootstrap_gof_test <- function(obj_value, bs_obj_values, alpha, bs_gof_p_ci) {
    .Call('_gmwm2_bootstrap_gof_test', PACKAGE = 'gmwm2', obj_value, bs_obj_values, alpha, bs_gof_p_ci)
}
...
lm_arma <- function(y, X) {
    .Call('_gmwm2_lm_arma', PACKAGE = 'gmwm2', y, X)
}
...
#' 
lm_dr <- function(x) {
    .Call('_gmwm2_lm_dr', PACKAGE = 'gmwm2', x)
}
...
B_matrix <- function(A, at_omega) {
    .Call('_gmwm2_B_matrix', PACKAGE = 'gmwm2', A, at_omega)
}
...
model_score <- function(A, D, omega, v_hat, obj_value) {
    .Call('_gmwm2_model_score', PACKAGE = 'gmwm2', A, D, omega, v_hat, obj_value)
}
...
obj_extract <- function(theta, objdesc, cur_position) {
    .Call('_gmwm2_obj_extract', PACKAGE = 'gmwm2', theta, objdesc, cur_position)
}
...
getObjFunStarting <- function(theta, desc, objdesc, model_type, wv_empir, tau) {
    .Call('_gmwm2_getObjFunStarting', PACKAGE = 'gmwm2', theta, desc, objdesc, model_type, wv_empir, tau)
}
...
getObjFun <- function(theta, desc, objdesc, model_type, omega, wv_empir, tau) {
    .Call('_gmwm2_getObjFun', PACKAGE = 'gmwm2', theta, desc, objdesc, model_type, omega, wv_empir, tau)
}
...
do_polyroot_arma <- function(z) {
    .Call('_gmwm2_do_polyroot_arma', PACKAGE = 'gmwm2', z)
}
...
do_polyroot_cpp <- function(z) {
    .Call('_gmwm2_do_polyroot_cpp', PACKAGE = 'gmwm2', z)
}
...
arma_to_wv <- function(ar, ma, sigma2, tau) {
    .Call('_gmwm2_arma_to_wv', PACKAGE = 'gmwm2', ar, ma, sigma2, tau)
}
...
acf_sum <- function(ar, ma, last_tau, alpha = 0.99) {
    .Call('_gmwm2_acf_sum', PACKAGE = 'gmwm2', ar, ma, last_tau, alpha)
}
...
arma_to_wv_app <- function(ar, ma, sigma2, tau, alpha = 0.9999) {
    .Call('_gmwm2_arma_to_wv_app', PACKAGE = 'gmwm2', ar, ma, sigma2, tau, alpha)
}
...
arma11_to_wv <- function(phi, theta, sigma2, tau) {
    .Call('_gmwm2_arma11_to_wv', PACKAGE = 'gmwm2', phi, theta, sigma2, tau)
}
...
ar1_to_wv <- function(phi, sigma2, tau) {
    .Call('_gmwm2_ar1_to_wv', PACKAGE = 'gmwm2', phi, sigma2, tau)
}
...
ma1_to_wv <- function(theta, sigma2, tau) {
    .Call('_gmwm2_ma1_to_wv', PACKAGE = 'gmwm2', theta, sigma2, tau)
}
...
qn_to_wv <- function(q2, tau) {
    .Call('_gmwm2_qn_to_wv', PACKAGE = 'gmwm2', q2, tau)
}
...
wn_to_wv <- function(sigma2, tau) {
    .Call('_gmwm2_wn_to_wv', PACKAGE = 'gmwm2', sigma2, tau)
}
...
rw_to_wv <- function(gamma2, tau) {
    .Call('_gmwm2_rw_to_wv', PACKAGE = 'gmwm2', gamma2, tau)
}
...
dr_to_wv <- function(omega, tau) {
    .Call('_gmwm2_dr_to_wv', PACKAGE = 'gmwm2', omega, tau)
}
...
theoretical_wv <- function(theta, desc, objdesc, tau) {
    .Call('_gmwm2_theoretical_wv', PACKAGE = 'gmwm2', theta, desc, objdesc, tau)
}
...
decomp_theoretical_wv <- function(theta, desc, objdesc, tau) {
    .Call('_gmwm2_decomp_theoretical_wv', PACKAGE = 'gmwm2', theta, desc, objdesc, tau)
}
...
decomp_to_theo_wv <- function(decomp) {
    .Call('_gmwm2_decomp_to_theo_wv', PACKAGE = 'gmwm2', decomp)
}
...
read_imu <- function(file_path, imu_type) {
    .Call('_gmwm2_read_imu', PACKAGE = 'gmwm2', file_path, imu_type)
}
...
seq_cpp <- function(a, b) {
    .Call('_gmwm2_seq_cpp', PACKAGE = 'gmwm2', a, b)
}
...
seq_len_cpp <- function(n) {
    .Call('_gmwm2_seq_len_cpp', PACKAGE = 'gmwm2', n)
}
...
quantile_cpp <- function(x, probs) {
    .Call('_gmwm2_quantile_cpp', PACKAGE = 'gmwm2', x, probs)
}
...
diff_cpp <- function(x, lag, differences) {
    .Call('_gmwm2_diff_cpp', PACKAGE = 'gmwm2', x, lag, differences)
}
...
ARMAtoMA_cpp <- function(ar, ma, lag_max) {
    .Call('_gmwm2_ARMAtoMA_cpp', PACKAGE = 'gmwm2', ar, ma, lag_max)
}
...
cfilter <- function(x, filter, sides, circular) {
    .Call('_gmwm2_cfilter', PACKAGE = 'gmwm2', x, filter, sides, circular)
}
...
rfilter <- function(x, filter, init) {
    .Call('_gmwm2_rfilter', PACKAGE = 'gmwm2', x, filter, init)
}
...
ARMAacf_cpp <- function(ar, ma, lag_max) {
    .Call('_gmwm2_ARMAacf_cpp', PACKAGE = 'gmwm2', ar, ma, lag_max)
}
...
#' dft_acf(x)
dft_acf <- function(x) {
    .Call('_gmwm2_dft_acf', PACKAGE = 'gmwm2', x)
}
...
mean_diff <- function(x) {
    .Call('_gmwm2_mean_diff', PACKAGE = 'gmwm2', x)
}
...
num_rep <- function(x, n) {
    .Call('_gmwm2_num_rep', PACKAGE = 'gmwm2', x, n)
}

#' @rdname diff_inv
intgr_vec <- function(x, xi, lag) {
    .Call('_gmwm2_intgr_vec', PACKAGE = 'gmwm2', x, xi, lag)
}
...
diff_inv_values <- function(x, lag, d, xi) {
    .Call('_gmwm2_diff_inv_values', PACKAGE = 'gmwm2', x, lag, d, xi)
}
...
diff_inv <- function(x, lag, d) {
    .Call('_gmwm2_diff_inv', PACKAGE = 'gmwm2', x, lag, d)
}
...
.acf <- function(x, lagmax = 0L, cor = TRUE, demean = TRUE) {
    .Call('_gmwm2_acf', PACKAGE = 'gmwm2', x, lagmax, cor, demean)
}
...
rtruncated_normal <- function(n, mu, sigma, a, b) {
    .Call('_gmwm2_rtruncated_normal', PACKAGE = 'gmwm2', n, mu, sigma, a, b)
}
...
sarma_objdesc <- function(ar, ma, sar, sma, s, i, si) {
    .Call('_gmwm2_sarma_objdesc', PACKAGE = 'gmwm2', ar, ma, sar, sma, s, i, si)
}
...
sarma_calculate_spadding <- function(np, nq, nsp, nsq, ns) {
    .Call('_gmwm2_sarma_calculate_spadding', PACKAGE = 'gmwm2', np, nq, nsp, nsq, ns)
}
...
sarma_components <- function(objdesc) {
    .Call('_gmwm2_sarma_components', PACKAGE = 'gmwm2', objdesc)
}

#' Efficient way to merge items together
#' @keywords internal
sarma_params_construct <- function(ar, ma, sar, sma) {
    .Call('_gmwm2_sarma_params_construct', PACKAGE = 'gmwm2', ar, ma, sar, sma)
}
...
sarma_expand_unguided <- function(params, np, nq, nsp, nsq, ns, p, q) {
    .Call('_gmwm2_sarma_expand_unguided', PACKAGE = 'gmwm2', params, np, nq, nsp, nsq, ns, p, q)
}
...
sarma_expand <- function(params, objdesc) {
    .Call('_gmwm2_sarma_expand', PACKAGE = 'gmwm2', params, objdesc)
}
...
get_summary <- function(theta, desc, objdesc, model_type, wv_empir, theo, scales, V, omega, obj_value, N, alpha, robust, eff, inference, fullV, bs_gof, bs_gof_p_ci, bs_theta_est, bs_ci, B) {
    .Call('_gmwm2_get_summary', PACKAGE = 'gmwm2', theta, desc, objdesc, model_type, wv_empir, theo, scales, V, omega, obj_value, N, alpha, robust, eff, inference, fullV, bs_gof, bs_gof_p_ci, bs_theta_est, bs_ci, B)
}
...
pseudo_logit_inv <- function(x) {
    .Call('_gmwm2_pseudo_logit_inv', PACKAGE = 'gmwm2', x)
}
...
logit_inv <- function(x) {
    .Call('_gmwm2_logit_inv', PACKAGE = 'gmwm2', x)
}
...
pseudo_logit <- function(x) {
    .Call('_gmwm2_pseudo_logit', PACKAGE = 'gmwm2', x)
}
...
#' x.sim.transformed = logit(x.sim)
logit <- function(x) {
    .Call('_gmwm2_logit', PACKAGE = 'gmwm2', x)
}
...
logit2 <- function(x) {
    .Call('_gmwm2_logit2', PACKAGE = 'gmwm2', x)
}
...
logit2_inv <- function(x) {
    .Call('_gmwm2_logit2_inv', PACKAGE = 'gmwm2', x)
}
...
transform_values <- function(theta, desc, objdesc, model_type) {
    .Call('_gmwm2_transform_values', PACKAGE = 'gmwm2', theta, desc, objdesc, model_type)
}
...
untransform_values <- function(theta, desc, objdesc, model_type) {
    .Call('_gmwm2_untransform_values', PACKAGE = 'gmwm2', theta, desc, objdesc, model_type)
}
...
#' @keywords internal
minroot <- function(x) {
    .Call('_gmwm2_minroot', PACKAGE = 'gmwm2', x)
}
...
invert_check <- function(x) {
    .Call('_gmwm2_invert_check', PACKAGE = 'gmwm2', x)
}
...
count_models <- function(desc) {
    .Call('_gmwm2_count_models', PACKAGE = 'gmwm2', desc)
}
...
order_AR1s <- function(theta, desc, objdesc) {
    .Call('_gmwm2_order_AR1s', PACKAGE = 'gmwm2', theta, desc, objdesc)
}
...
ar1_to_gm <- function(theta, freq) {
    .Call('_gmwm2_ar1_to_gm', PACKAGE = 'gmwm2', theta, freq)
}
...
gm_to_ar1 <- function(theta, freq) {
    .Call('_gmwm2_gm_to_ar1', PACKAGE = 'gmwm2', theta, freq)
}
...
model_objdesc <- function(desc) {
    .Call('_gmwm2_model_objdesc', PACKAGE = 'gmwm2', desc)
}
...
model_theta <- function(desc) {
    .Call('_gmwm2_model_theta', PACKAGE = 'gmwm2', desc)
}
...
model_process_desc <- function(desc) {
    .Call('_gmwm2_model_process_desc', PACKAGE = 'gmwm2', desc)
}
...
ci_eta3 <- function(y, dims, alpha_ov_2) {
    .Call('_gmwm2_ci_eta3', PACKAGE = 'gmwm2', y, dims, alpha_ov_2)
}
...
ci_eta3_robust <- function(wv_robust, wv_ci_class, alpha_ov_2, eff) {
    .Call('_gmwm2_ci_eta3_robust', PACKAGE = 'gmwm2', wv_robust, wv_ci_class, alpha_ov_2, eff)
}
...
ci_wave_variance <- function(signal_modwt_bw, wv, type = "eta3", alpha_ov_2 = 0.025, robust = FALSE, eff = 0.6) {
    .Call('_gmwm2_ci_wave_variance', PACKAGE = 'gmwm2', signal_modwt_bw, wv, type, alpha_ov_2, robust, eff)
}
...
wave_variance <- function(signal_modwt_bw, robust = FALSE, eff = 0.6) {
    .Call('_gmwm2_wave_variance', PACKAGE = 'gmwm2', signal_modwt_bw, robust, eff)
}
...
wvar_cpp <- function(signal_modwt_bw, robust, eff, alpha, ci_type) {
    .Call('_gmwm2_wvar_cpp', PACKAGE = 'gmwm2', signal_modwt_bw, robust, eff, alpha, ci_type)
}
...
modwt_wvar_cpp <- function(signal, nlevels, robust, eff, alpha, ci_type, strWavelet, decomp) {
    .Call('_gmwm2_modwt_wvar_cpp', PACKAGE = 'gmwm2', signal, nlevels, robust, eff, alpha, ci_type, strWavelet, decomp)
}
...
batch_modwt_wvar_cpp <- function(signal, nlevels, robust, eff, alpha, ci_type, strWavelet, decomp) {
    .Call('_gmwm2_batch_modwt_wvar_cpp', PACKAGE = 'gmwm2', signal, nlevels, robust, eff, alpha, ci_type, strWavelet, decomp)
}
...
scales_cpp <- function(nb_level) {
    .Call('_gmwm2_scales_cpp', PACKAGE = 'gmwm2', nb_level)
}
...
qmf <- function(g, inverse = TRUE) {
    .Call('_gmwm2_qmf', PACKAGE = 'gmwm2', g, inverse)
}
...
haar_filter <- function() {
    .Call('_gmwm2_haar_filter', PACKAGE = 'gmwm2')
}
...
#' d4_filter()
d4_filter <- function() {
    .Call('_gmwm2_d4_filter', PACKAGE = 'gmwm2')
}
...
#' mb4_filter()
mb4_filter <- function() {
    .Call('_gmwm2_mb4_filter', PACKAGE = 'gmwm2')
}
...
#' w4_filter()
w4_filter <- function() {
    .Call('_gmwm2_w4_filter', PACKAGE = 'gmwm2')
}
...
#' fk4_filter()
fk4_filter <- function() {
    .Call('_gmwm2_fk4_filter', PACKAGE = 'gmwm2')
}
...
#' d6_filter()
d6_filter <- function() {
    .Call('_gmwm2_d6_filter', PACKAGE = 'gmwm2')
}
...
#' fk6_filter()
fk6_filter <- function() {
    .Call('_gmwm2_fk6_filter', PACKAGE = 'gmwm2')
}
...
#' d8_filter()
d8_filter <- function() {
    .Call('_gmwm2_d8_filter', PACKAGE = 'gmwm2')
}
...
#' fk8_filter()
fk8_filter <- function() {
    .Call('_gmwm2_fk8_filter', PACKAGE = 'gmwm2')
}
...
#' la8_filter()
la8_filter <- function() {
    .Call('_gmwm2_la8_filter', PACKAGE = 'gmwm2')
}
...
#' mb8_filter()
mb8_filter <- function() {
    .Call('_gmwm2_mb8_filter', PACKAGE = 'gmwm2')
}
...
bl14_filter <- function() {
    .Call('_gmwm2_bl14_filter', PACKAGE = 'gmwm2')
}
...
fk14_filter <- function() {
    .Call('_gmwm2_fk14_filter', PACKAGE = 'gmwm2')
}
...
#' d16_filter()
d16_filter <- function() {
    .Call('_gmwm2_d16_filter', PACKAGE = 'gmwm2')
}
...
la16_filter <- function() {
    .Call('_gmwm2_la16_filter', PACKAGE = 'gmwm2')
}
...
mb16_filter <- function() {
    .Call('_gmwm2_mb16_filter', PACKAGE = 'gmwm2')
}
...
la20_filter <- function() {
    .Call('_gmwm2_la20_filter', PACKAGE = 'gmwm2')
}
...
bl20_filter <- function() {
    .Call('_gmwm2_bl20_filter', PACKAGE = 'gmwm2')
}
...
fk22_filter <- function() {
    .Call('_gmwm2_fk22_filter', PACKAGE = 'gmwm2')
}
...
mb24_filter <- function() {
    .Call('_gmwm2_mb24_filter', PACKAGE = 'gmwm2')
}
...
select_filter <- function(filter_name = "haar") {
    .Call('_gmwm2_select_filter', PACKAGE = 'gmwm2', filter_name)
}
